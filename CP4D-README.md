...
![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/architecture.png)
...
![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/create_prj.png)

Define the project by giving a Name and hit 'Create'.

![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/def_prj.png)

## 3. Add Data

[Clone this repo](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm)
Navigate to [Data](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/tree/master/Data) and save the file on the disk. 

Click on Assets and select Browse and add the csv file from your file system.

![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/add_asset.png)

## 4. Add Asset as Auto AI

Click on Add to project and select AutoAI experiment.

![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/sel_auto_ai.png)
...
![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/create_exp.png)
...
![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/import_csv.png)
...
![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/sel_target.png)

We can click on experiment settings to adjust the holdout sample and training sample under source settings.

![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/sample_split.png)
...
![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/prediction_settings.png)
...
![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/generate_pipelines.png)

Click on pipeline 2 (which is ranked 1) to see the evaluation metrics on the left side.

![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/pipeline-2.png)
...
![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/metrics.png)
...
![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/model_eval.png)
...
![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/feature_imp.png)
...
![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/select_model.png)
...
![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/deploy_mdl.png)

In the next step, click on Add Deployment on the right side above `Actions.`

![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/add_dply.png)

Define the deployment by giving a name and hit `Save.` Note that, the model will get deployed as web service as a ReST API.

![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/crt_dply.png)

The deployment will get initialized and the status will show as `ready` when it is complete.

![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/dply_ready.png)
...
![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/overview.png)
...
![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/form.png)
...
![](https://github.ibm.com/sharrkum/supply-chain-optimization-using-ibm/blob/master/images/json.png))
